24 jan 2008 tfb:
----------------
I was unable to get portaudio to build on win32 using msvc6, as it relies on many types
etc... that only showed up in later platform sdks (it makes calls to dx9 etc).  So I
built binaries with VS .net 2003, after copying the ASIO files as described below.
