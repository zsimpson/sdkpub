...
' Library Call Demonstrated:    Mccdaq.MccBoard.DaqInScan()and Mccdaq.MccBoard.GetTCValues()
'
...
Friend Class frmDataDisplay
    ...
    Const ChanCount As Integer = 6 ' Number of channels in scan
    Const TcChanCount As Integer = 2 ' Number of thermocouple channels
    Const NumPoints As Integer = 10 ' Number of data points to collect
    Const NumElements As Integer = ChanCount * NumPoints
    Const NumTCElements As Integer = TcChanCount * NumPoints

    'Create a new MccBoard object for Board 0
    Private DaqBoard As MccDaq.MccBoard = New MccDaq.MccBoard(0)

    Dim ADData(NumElements) As Short ' dimension an array to hold the input values
    ...
    Dim CBScale As MccDaq.TempScale
    Dim FirstPoint As Integer
    Dim TempValArray(NumTCElements) As Single
    ...
    Private Sub frmDataDisplay_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        ChanArray(2) = 0
        ChanTypeArray(2) = MccDaq.ChannelType.CJC
        GainArray(2) = MccDaq.Range.NotUsed

        ChanArray(3) = 0
        ChanTypeArray(3) = MccDaq.ChannelType.TC
        GainArray(3) = MccDaq.Range.NotUsed

        lblChan2.Text = "0"
        lblShowChanType(2).Text = "TC"
        lblShowRange(2).Text = "NotUsed"

        ChanArray(4) = 1
        ChanTypeArray(4) = MccDaq.ChannelType.CJC
        GainArray(4) = MccDaq.Range.NotUsed

        ChanArray(5) = 1
        ChanTypeArray(5) = MccDaq.ChannelType.TC
        GainArray(5) = MccDaq.Range.NotUsed

        lblChan3.Text = "1"
        lblShowChanType(3).Text = "TC"
        lblShowRange(3).Text = "NotUsed"
    ...
    Private Sub cmdRead_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdRead.Click
        ...
        ULStat = DaqBoard.GetTCValues(ChanArray, ChanTypeArray, ChanCount, MemHandle, FirstPoint, Count, CBScale, TempValArray(0))
...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lblDemoFunction.Text = "Demonstration of MccDaq.MccBoard.DaqInScan() and MccDaq.MccBoard.GetTCValue()"
