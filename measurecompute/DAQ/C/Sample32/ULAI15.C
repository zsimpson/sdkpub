...
Library Call Demonstrated:    cbAInScan(), SCALEDATA Option

Purpose:                      Scans a range of A/D Input Channels and
                              stores the scaled sample data in an array.
...
void main ()
   ...
   */
    ...
    ClearScreen();
    printf ("Demonstration of cbAInScan() in SCALEDATA mode\n\n");
