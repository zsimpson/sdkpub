...
/* Modified by Intel OpenCV team. Added lines 53-56 in order to prevent 
   the parser exceptions throwing in specific cases. The fix is consistent 
   with the EiC Standard version. */
