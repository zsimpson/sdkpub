...
/* Modified by Intel OpenCV team. The type_expr structure has been enriched with the 
   symentry information (line 29). This is for enabling enhanced editor tips 
   in the environment. */
