...
// ZBS removed gif because it was causing problems with libstdc++ 3.3.1 and I would rather
// sacrifice GIF than make everyone upgrade. (Although I really don't understand why the symbols in std were missing)
	// TFB reinstated 21 January 2007
