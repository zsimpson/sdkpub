...
// NOTE: TFB brought this over from the older glfw in sdkpub, but I am 
//       only bring over the mods that I find are in use.  I think the 
//       others were toward a multi-win interface, which isn't used.
//========================================================================

GLFWAPI int GLFWAPIENTRY glfwZBSExt_GetHWND()
{
	#ifdef WIN32
	return (int)_glfwWin.window;
	#endif
}
