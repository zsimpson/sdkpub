...
// ZBS: These odd machos are done liek this so that you can use them in cases
// of sloppy unbracket if / else such as if( a ) GSL_ERROR; else return;
// Without the bogus while loop, that would generate an else without if
