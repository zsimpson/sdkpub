...
#if defined(complex)  /* MSVC defines complex in math.h */
  #define TEMPLATE_OLD_COMPLEX complex
  #undef complex
#endif
...
#define ONE {{1.0,0.0}}
#define BASE_EPSILON GSL_DBL_EPSILON
#if defined(TEMPLATE_OLD_COMPLEX)
  #undef complex
  #define complex TEMPLATE_OLD_COMPLEX
#endif
