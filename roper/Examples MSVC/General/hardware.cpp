...
void hardware::OnFast() 
{
	adctype = 1;
	
}

void hardware::OnSelchangeInterface() 
{
	int itype;
...
void hardware::OnSelchangeControl() 
{
	int ctype;
...
void hardware::OnSelchangeIoadd() 
{
	int iotype;
...
void hardware::OnSelchangeInterrupt() 
{
	int irqtype;
...
void hardware::OnFull() 
{
	readouttype = ROM_FULL;
	
}

void hardware::SetComboCurSel(
...
void hardware::OnSelchangeControlver() 
{
	int vertype;
