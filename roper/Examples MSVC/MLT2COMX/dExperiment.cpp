...
BOOL CdExperiment::OnInitDialog()
{
	...
	Detector_ComboBox().SetItemData(13, HAM_64x1024);
	Detector_ComboBox().SetItemData(14, HAM_128x1024);
	Detector_ComboBox().SetItemData(15, HAM_256x1024);
	Detector_ComboBox().SetItemData(16, KDK_1024x1536);
	Detector_ComboBox().SetItemData(17, KDK_512x768);
	Detector_ComboBox().SetItemData(18, KDK_1035x1317);
	Detector_ComboBox().SetItemData(19, KDK_1024x1280);
	Detector_ComboBox().SetItemData(20, KDK_2044x2033);
	Detector_ComboBox().SetItemData(21, KDK_2048x3072);
	Detector_ComboBox().SetItemData(22, PID_330x1100_8phH);
	Detector_ComboBox().SetItemData(23, PID_532x1752);
	Detector_ComboBox().SetItemData(24, PID_330x1100_6phH);
	Detector_ComboBox().SetItemData(25, PID_240x330_MCT);
	Detector_ComboBox().SetItemData(26, PI_64x1024);
	Detector_ComboBox().SetItemData(27, PI_128x1024);
	Detector_ComboBox().SetItemData(28, PI_256x1024);
	Detector_ComboBox().SetItemData(29, RET_400x1200);
	Detector_ComboBox().SetItemData(30, RET_512x512);
	Detector_ComboBox().SetItemData(31, RET_1024x1024);
	Detector_ComboBox().SetItemData(32, RET_2048x2048);
	Detector_ComboBox().SetItemData(33, SIT_800x2000_B);
	Detector_ComboBox().SetItemData(34, SIT_800x2000_F);
	Detector_ComboBox().SetItemData(35, PI_800x1000_B);
	Detector_ComboBox().SetItemData(36, TEK_512x512_B_100ns);
	Detector_ComboBox().SetItemData(37, TEK_512x512_F_100ns);
	Detector_ComboBox().SetItemData(38, TEK_1024x1024_B_100ns);
	Detector_ComboBox().SetItemData(39, TEK_1024x1024_F_100ns);
	Detector_ComboBox().SetItemData(40, TEK_2048x2048);
	Detector_ComboBox().SetItemData(41, TEK_1024x1024_B_200ns);
	Detector_ComboBox().SetItemData(42, TEK_1024x1024_F_200ns);
	Detector_ComboBox().SetItemData(43, TEK_512x512_B_200ns);
	Detector_ComboBox().SetItemData(44, TEK_512x512_F_200ns);
	Detector_ComboBox().SetItemData(45, TEK_512x512D_B);
	Detector_ComboBox().SetItemData(46, TEK_512x512D_F);
	Detector_ComboBox().SetItemData(47, TEK_1024x1024_B_42usV);
	Detector_ComboBox().SetItemData(48, TEK_1024x1024D_B);
	Detector_ComboBox().SetItemData(49, TEK_1024x1024D_F);
	Detector_ComboBox().SetItemData(50, TEK_1024x1024D_B_T3);
	Detector_ComboBox().SetItemData(51, THM_576x384);
	Detector_ComboBox().SetItemData(52, THM_512x512);
	Detector_ComboBox().SetItemData(53, THM_256x1024);
	Detector_ComboBox().SetItemData(54, THM_2048x1024_FT);
...
void CdExperiment::OnOK() 
{
	...
	if (controller_ok)
	{
		...
		/* set the version of the the controller */
		...
		if( (error_code != 0) || !controller_ok )
			...
			CMainFrame::m_efID_EXPERIMENT_EXPERIMENTSETUP = TRUE;
			CMainFrame::m_efID_EXPERIMENT_ACQUIREEXPERIMENT = TRUE;
			}
	}
	WriteDefaults( expos, controltype,
...
void CdExperiment::OnFast() 
{
	adctype = 1;
	
}

void CdExperiment::OnSelchangeInterface() 
{
	int itype;
...
void CdExperiment::OnSelchangeControl() 
{
	int ctype;
...
void CdExperiment::OnSelchangeCcd() 
{
	int detecttype;
	...
	switch (detecttype)
		...
		case 12:				// EEV 256x1024 6-phase CCD30
			...
			break;
		case 13:				// HAMMA 64x1024
			ccdtype = HAM_64x1024;
			break;
		case 14:				// HAMMA 128x1024
			ccdtype = HAM_128x1024;
			break;
		case 15:				// HAMMA 256x1024
			ccdtype = HAM_256x1024;
			break;
		case 16:				// KODAK 1024x1536
			ccdtype = KDK_1024x1536;
			break;
		case 17:				// KODAK 512x768
			ccdtype = KDK_512x768;
			break;
		case 18:				// KODAK 1035x1317
			ccdtype = KDK_1035x1317;
			break;
		case 19:				// KODAK 1024x1280
			ccdtype = KDK_1024x1280;
			break;
		case 20:				// KODAK 2044x2033
			ccdtype = KDK_2044x2033;
			break;
		case 21:				// KODAK 2048x3072
			ccdtype = KDK_2048x3072;
			break;
		case 22:				// PI 330x1100 8-phase (horz)
			ccdtype = PID_330x1100_8phH;
			break;
		case 23:				// PI 532x1752
			ccdtype = PID_532x1752;
			break;
		case 24:				// PI 330x1100 6-phase
			ccdtype = PID_330x1100_6phH;
			break;
		case 25:				// PI 240x330 HgCdTe
		...
		case 28:				// PI 256x1024
			ccdtype = PI_256x1024;
			break;
		case 29:				// RET 400x1200
			ccdtype = RET_400x1200;
			break;
		case 30:				// RET 512x512
			ccdtype = RET_512x512;
			break;
		case 31:				// RET 1024x1024
			ccdtype = RET_1024x1024;
			break;
		case 32:				// RET 2048x2048
			ccdtype = RET_2048x2048;
			break;
		case 33:				// SIT 800x2000 Back Illm
			ccdtype = SIT_800x2000_B;
			break;
		case 34:				// SIT 800x2000 Front Illm
			ccdtype = SIT_800x2000_F;
			break;
		case 35:				// SIT 800x1000 Back
			ccdtype = PI_800x1000_B;
			break;
		case 36:				// TEK 512x512B [100ns]
			ccdtype = TEK_512x512_B_100ns;
			break;
		case 37:				// TEK 512x512F [100ns]
			ccdtype = TEK_512x512_F_100ns;
			break;
		case 38:				// TEK 1024x1024B [100ns]
			ccdtype = TEK_1024x1024_B_100ns;
			break;
		case 39:				// TEK 1024x1024F [100ns]
			ccdtype = TEK_1024x1024_F_100ns;
			break;
		case 40:				// TEK 2048x2048
			ccdtype = TEK_2048x2048;
			break;
		case 41:				// TEK 1024x1024B Illm
			ccdtype = TEK_1024x1024_B_200ns;
			break;
		case 42:				// TEK 1024x1024F Illm
			ccdtype = TEK_1024x1024_F_200ns;
			break;
		case 43:				// TEK 512x512B [200ns]
			ccdtype = TEK_512x512_B_200ns;
			break;
		case 44:				// TEK 512x512F [200ns]
			ccdtype = TEK_512x512_F_200ns;
			break;
		case 45:				// TEK 512x512D Back Illm
			ccdtype = TEK_512x512D_B;
			break;
		case 46:				// TEK 512x512D Front Illm
			ccdtype = TEK_512x512D_F;
			break;
		case 47:				// TEK 1024x1024B Back Illm 42usV
			ccdtype = TEK_1024x1024_B_42usV;
			break;
		case 48:				// TEK 1024x1024D Back Illm
			ccdtype = TEK_1024x1024D_B;
			break;
		case 49:				// TEK 1024x1024D Front Illm
			ccdtype = TEK_1024x1024D_F;
			break;
		case 50:				// TEK 1024x1024D Back Illm T3
		...
		case 53:				// TH 256x1024
			...
			break;
		case 54:				// TH 2048x1024
			ccdtype = THM_2048x1024_FT;
			break;
		}	
}	

void CdExperiment::OnSelchangeIoadd() 
{
	int iotype;
...
void CdExperiment::OnSelchangeInterrupt() 
{
	int irqtype;
...
void CdExperiment::OnFt() 
{
	readouttype = ROM_FRAME_TRANSFER;
	
}

void CdExperiment::OnFull() 
{
	readouttype = ROM_FULL;
	
}

void CdExperiment::SetComboCurSel(
...
void CdExperiment::SetDefaults( )
{
	ReadDefaults( &expos, &controltype,
					&ccdtype, &interfacetype, &ioaddtype, &interrupttype,
					&adctype, &readouttype, &versiontype );
...
void CdExperiment::OnSelchangeControlver() 
{
	int vertype;
