// dExperiment.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CdExperiment dialog

class CdExperiment : public CDialog
{
// Construction
public:
	CdExperiment(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CdExperiment)
