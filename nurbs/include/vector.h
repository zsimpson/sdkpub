...
namespace PLib {
  ...
  template <class T> Vector<T> operator*(const Vector<T>& v, const NComplex d);
		    
  template <class T> Vector<T> operator*(const double d,const Vector<T>& v) ;
  template <class T> Vector<T> operator*(const NComplex d,const Vector<T>& v) ;

  template<> Vector<NComplex>  operator*(const Vector<NComplex>& v, const double d);
  template <> Vector<NComplex>  operator*(const Vector<NComplex>& v, const NComplex d);
  ...
  */
  ...
  public:
    ...
    friend Vector<T> operator* <>(const Vector<T>& v, const NComplex d);
    
    friend Vector<T> operator* <>(const double d,const Vector<T>& v) ;
    friend Vector<T> operator* <>(const NComplex d,const Vector<T>& v) ;
...
//    friend int operator!= <>(const Vector<T>& a,const Vector<T>& b);
  ...
  template<class T> inline 
    Vector<T>  operator*(const NComplex d, const Vector<T>& v) //!< Multiplies by a Comples 
    {
      return v*d ;
    }
...
typedef PLib::Vector<NComplex> Vector_COMPLEX ;
...
typedef PLib::Vector<NComplex> PlVector_complex ;
