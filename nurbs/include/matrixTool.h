...
namespace PLib {
  ...
  inline NComplex minimum(NComplex a, NComplex b){
    double r,i ;
  ...
  inline NComplex maximum(NComplex a, NComplex b){
  double r,i ;
  ...
  inline NComplex minimumByRef(const NComplex &a, const NComplex &b){
    double r,i ;
    r = minimum(real(a),real(b)) ;
    i = minimum(imag(a),imag(b)) ;
    return NComplex(r,i) ;
  ...
  inline NComplex maximumByRef(const NComplex &a, const NComplex &b){
    double r,i ;
    r = maximum(real(a),real(b)) ;
    i = maximum(imag(a),imag(b)) ;
    return NComplex(r,i) ;
