...
namespace PLib {
  ...
  template <class T> PLib::Matrix<T> operator*(const NComplex&,const PLib::Matrix<T>&);
  ...
  template <> PLib::Matrix<NComplex>  operator*(const double d, const PLib::Matrix<NComplex> &a);
  template <> PLib::Matrix<NComplex>  operator*(const NComplex &d, const PLib::Matrix<NComplex> &a);
  ...
  template<class T>
	...
	return v; }
      ...
      friend Matrix<T> operator* <>(const double,
				    const Matrix<T>&);
      friend Matrix<T> operator* <>(const NComplex&,
				    const Matrix<T>&);
...
typedef PLib::Matrix<NComplex> Matrix_COMPLEX ;
...
typedef PLib::Matrix<NComplex> PlMatrix_complex ;
