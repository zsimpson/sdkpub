...
void intersectSurfaces(const ParaSurface<T,N> &surfA, const ParaSurface<T,N> &surfB, BasicList<InterPoint<T,N> > &points, int maxI, T um, T uM, T vm, T vM){
  ...
  d = (T)0.01 ; // should be dependant on the control points locations
  T direction = 1 ; 
