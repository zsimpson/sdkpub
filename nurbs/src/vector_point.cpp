...
template Vector<Point3Df> operator*(const Vector<Point3Df>& v, const NComplex d);
...
template Vector<Point3Dd> operator*(const Vector<Point3Dd>& v, const NComplex d);
...
template Vector<Point2Df> operator*(const Vector<Point2Df>& v, const NComplex d);
...
template Vector<Point2Dd> operator*(const Vector<Point2Dd>& v, const NComplex d);
