...
template struct BasicNode<float> ;
template struct BasicNode<double> ;
template struct BasicNode<int> ;
template struct BasicNode<char> ;
template struct BasicNode<unsigned char> ;
template struct BasicNode<PLib::Point3Df> ;
template struct BasicNode<PLib::HPoint3Df> ;
template struct BasicNode<PLib::Point3Dd> ;
template struct BasicNode<PLib::HPoint3Dd> ;
template struct BasicNode<PLib::Point2Df> ;
template struct BasicNode<PLib::HPoint2Df> ;
template struct BasicNode<PLib::Point2Dd> ;
template struct BasicNode<PLib::HPoint2Dd> ;
template struct BasicNode<PLib::Coordinate> ;
