...
namespace PLib {
  ...
  template Vector<HPoint3Df> operator*(const Vector<HPoint3Df>& v, const NComplex d);
  ...
  template Vector<HPoint3Dd> operator*(const Vector<HPoint3Dd>& v, const NComplex d);
  ...
  template Vector<HPoint2Df> operator*(const Vector<HPoint2Df>& v, const NComplex d);
  ...
  template Vector<HPoint2Dd> operator*(const Vector<HPoint2Dd>& v, const NComplex d);
