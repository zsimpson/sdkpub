...
*
* Example Task Types: 
*    BUF, 1CH, BURST, ASYNC, EXTTIM, INTTRIG
*
...
*     WFM_Load, WFM_ClockRate, WFM_Group_Control, WFM_Check,
...
*     connect a digital pulse train to the 'external update' pin.
*
...
void main(void)
{
    ...
    if (iStatus == 0) {
        ...
        printf(" Apply your external update clock signal to the 'external update' pin to update the waveform.\n");
