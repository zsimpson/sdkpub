...
# ADD CPP /nologo /W3 /GX /O2 /I "." /I ".\porttime" /I "pm_common" /I "porttime" /I "pm_win" /D "WIN32" /D "_LIB" /D "NEWBUFFER" /D "USE_DLL_FOR_CLEANUP" /YX /FD /c
...
# ADD LIB32 /nologo /out:"pm_win\Release\portmidi.lib"
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I ".\pm_common" /I "...\porttime" /I "pm_common" /I "porttime" /I "pm_win" /D "_LIB" /D "DEBUG" /D "PM_CHECK_ERRORS" /D "WIN32" /D "_DEBUG" /D "USE_DLL_FOR_CLEANUP" /D "NEWBUFFER" /YX /FD /GZ /c
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"pm_win\Debug\portmidi.lib"
